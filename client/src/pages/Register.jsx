  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#09090b] px-6 py-20 text-white">
      <div className="w-full max-w-md rounded-[2rem] border border-white/10 bg-[#18181b]/90 p-8 shadow-2xl shadow-black/30">
        ...
        <p className="mt-2 text-sm text-zinc-400">Join AURA and unlock exclusive drops.</p>

        <form className="mt-8 space-y-4">
          <input className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 outline-none ring-0" placeholder="Full Name" />
